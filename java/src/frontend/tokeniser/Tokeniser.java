/* The following code was generated by JFlex 1.4.3 on 01/09/13 11:25 */

package frontend.tokeniser;

import static frontend.tokeniser.TokeniserSym.DIVIDE;
import static frontend.tokeniser.TokeniserSym.INTEGER_LITERAL;
import static frontend.tokeniser.TokeniserSym.MINUS;
import static frontend.tokeniser.TokeniserSym.PLUS;
import static frontend.tokeniser.TokeniserSym.TIMES;
 ...
 * 1.4.3 on 01/09/13 11:25 from the specification file
 * <tt>/home/tetigi/toucan/java/src/frontend/tokeniser/tokeniser.lex</tt>
 */
final class Tokeniser implements java_cup.runtime.Scanner {
   ...
   */
  private static final String ZZ_CMAP_PACKED = "\11\0\1\3\1\2\1\0\1\3\1\1\22\0\1\3\11\0\1\10"
      + "\1\6\1\0\1\7\1\0\1\11\1\4\11\5\uffc6\0";
  ...
  private static final String ZZ_ACTION_PACKED_0 = "\2\0\1\1\2\2\2\3\1\4\1\5\1\6\1\7";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\12\0\24\0\36\0\24\0\24\0\50\0\24"
      + "\0\24\0\24\0\24";
  ...
  private static final String ZZ_TRANS_PACKED_0 = "\1\3\1\4\2\5\1\6\1\7\1\10\1\11\1\12"
      + "\1\13\12\3\14\0\1\5\13\0\2\7\4\0";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 = "\2\0\1\11\1\1\2\11\1\1\4\11";
  ...
  private Symbol sym(final int type, final Object value) {
   ...
   */
  Tokeniser(final java.io.Reader in) {
   ...
   */
  Tokeniser(final java.io.InputStream in) {
  ...
  public java_cup.runtime.Symbol next_token() throws java.io.IOException {
    ...
    while (true) {
      ...
      case 10:
        break;
      case 3: {
        return symbol(INTEGER_LITERAL, createToken(yytext(), yycolumn));
      }
      case 11:
        break;
      case 1: {
        ...
        if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
          ...
          zzDoEOF();
          {
            return new java_cup.runtime.Symbol(
                frontend.tokeniser.TokeniserSym.EOF);
          }
        } else {
